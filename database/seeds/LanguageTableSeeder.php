...
class LanguageTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $attributes = ['language_id', 'language', 'country', 'name', 'name_ascii', 'status'];
        $languages = [
        ...
        foreach ($languages as $language) {
            Language::create(array_combine($attributes, $language));
        }

        #Optional Import Translation Files
        Artisan::call('translations:import');
        echo 'Done importing translation files. ';
    }
}

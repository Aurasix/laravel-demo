...
class TranslationController extends Controller
{
    ...
    public function getIndex($group = null)
    {
        ...
        $groups = [''=>trans('translations.selector.choose')] + $groups;
    ...
    public function getTranslate($lang, Request $request)
    {
        if (empty($lang)) abort(404);

        $find = Language::where('language', $lang)->firstOrFail();
        $request->session()->put('lang', $find->language);
